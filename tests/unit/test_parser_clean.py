...
class TestURLValidator:
    ...
    def test_invalid_urls(self):
        ...
        invalid_urls = [
            ...
            "https://",
            "http://localhost",  # localhost excluded
            "https://192.168.1.1",  # IP addresses excluded
        ]
    ...
    def test_excluded_file_extensions(self):
        ...
        for url in excluded_urls:
            assert not self.validator.is_valid_url(url), f"URL with excluded extension should be invalid: {url}"
    ...
    def test_non_html_resources(self):
        ...
        for url in non_html_urls:
            assert not self.validator.is_valid_url(url), f"Non-HTML URL should be invalid: {url}"
